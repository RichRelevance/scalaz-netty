...
```sbt
libraryDependencies += "org.scalaz.netty" %% "scalaz-netty" % "0.1.6"
```

Builds are published for Scala 2.11.5.  The latest stable release is **0.1.6**.  The upstream dependencies for this project include the following:
